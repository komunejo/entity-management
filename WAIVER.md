...
By installing or using entity-manager — its validation engine, its skill instructions, or its documentation — I acknowledge and agree to the following.

**I run agentic AI on my own responsibility.** entity-manager is designed to be operated by AI agents that read, create, and modify files in my projects. I remain the owner of those projects and the reviewer of last resort: I will keep my work under version control or backed up, and I will review changes that agents make to my files.
